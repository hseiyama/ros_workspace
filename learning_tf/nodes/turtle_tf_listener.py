...
if __name__ == '__main__':
    ...
    '''
    #listener.waitForTransform("/turtle2", "/turtle1", rospy.Time(), rospy.Duration(4.0)) # 追加コード(tf取得できない問題を解決)
    '''
    while not rospy.is_shutdown():
        try:
            ...
            #listener.waitForTransform("/turtle2", "/turtle1", now, rospy.Duration(3.0)) # 追加コード(tf取得できない問題を解決)
